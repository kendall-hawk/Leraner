...
(function(global) {
    ...
    function AppController(config) {
        ...
        function executeStartupSequence(options) {
            try {
                var startupSteps = [
                    { name: 'initializeFoundation', fn: initializeFoundationLayer },
                    { name: 'initializeCoreModules', fn: initializeCoreModules },
                    { name: 'setupModuleIntegration', fn: setupModuleIntegration },
                    { name: 'restoreApplicationState', fn: restoreApplicationState },
                    { name: 'finalizeStartup', fn: finalizeStartup }
                ];
